...
const portError = (value: string): string | undefined =>
  integerFieldError(value, "The port", PortRule);
const minInstancesError = (value: string): string | undefined =>
  integerFieldError(value, "The minimum number of instances", MinInstancesRule);
const maxInstancesError = (value: string): string | undefined =>
  integerFieldError(value, "The maximum number of instances", MaxInstancesRule);
